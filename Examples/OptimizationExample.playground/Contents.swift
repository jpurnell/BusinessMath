...
func gradientDescentComparisonExample() throws {
	...
	print("   Solution: [\(basicResult.solution.toArray().map({ $0.number() }).joined(separator: ", "))]")
	...
	print("   Solution: [\(momentumResult.solution.toArray().map({ $0.number() }).joined(separator: ", "))]")
	...
	print("   Solution: [\(adamResult.solution.toArray().map({ $0.number() }).joined(separator: ", "))]")
...
func newtonRaphsonExample() throws {
	...
	print("Minimizing quadratic function from [\(initial.toArray().map({ $0.number() }).joined(separator: ", "))]")
	print()
	...
	print("   Solution: [\(newtonResult.solution.toArray().map({ $0.number() }).joined(separator: ", "))]")
	...
	print("   Solution: [\(bfgsResult.solution.toArray().map({ $0.number() }).joined(separator: ", "))]")
