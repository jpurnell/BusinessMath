...
struct TemplateRegistryExample {
    ...
    static func main() async throws {
        ...
        print("  Initial MRR: $\(String(format: "%.2f", saasModel.initialMRR))")
        print("  Customer LTV: $\(String(format: "%.2f", ltv ?? 0))")
        print("  LTV:CAC Ratio: \(String(format: "%.2f", ltvToCAC ?? 0))")
        print("  MRR after 12 months: $\(String(format: "%.2f", projection.values[11]))\n")
