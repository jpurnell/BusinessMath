...
// Result: ~0.000008 — zero to the solver's tolerance, which on a $100,000 outlay is a
// relative residual of about 8e-11. The figure here was previously quoted as 0.0000001,
// which claimed two more digits of precision than the root finder delivers.
```
