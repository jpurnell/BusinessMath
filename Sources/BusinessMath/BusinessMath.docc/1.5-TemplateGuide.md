...
let modelSaaS = SaaSModel(
	...
	let saasLTV = modelSaaS.calculateLTV()             // Customer Lifetime Value
	let saasLTVToCAC = modelSaaS.calculateLTVtoCAC()  // LTV:CAC ratio (should be > 3.0)
	...
	print("LTV:CAC: \(saasLTVToCAC.number(1))x")
...
for (name, advancedSaaSModel) in scenarios {
	...
	let ltv = advancedSaaSModel.calculateLTV()
	let ltvToCAC = advancedSaaSModel.calculateLTVtoCAC()
...
let subscriptionLTV = subscriptionBoxModel.calculateCustomerLifetimeValue()
let subscriptionLTVToCAC = subscriptionBoxModel.calculateLTVtoCAC()
...
print("LTV:CAC: \(subscriptionLTVToCAC.number())x")
```
...
for (name, subscriptionBoxModel) in tiers {
	...
	print("  LTV: \(subscriptionBoxModel.calculateCustomerLifetimeValue().currency())")
}
```
