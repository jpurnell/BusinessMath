...
print("LTV:CAC: \(ltvToCAC.formatted())x")
...
print("Inventory Turns: \(inventoryTurns.formatted())x per year")
...
print("Break-Even Units: \(breakEvenUnits.formatted())")
...
print("Buyer:Seller Ratio: \(buyerSellerRatio.formatted()):1")
...
print("\nEngagement:")
print("Transactions/Buyer: \(transactionsPerBuyer.formatted())")
print("Transactions/Seller: \(transactionsPerSeller.formatted())")
```
...
print("Buyers per Seller: \(buyersPerSeller.formatted())")
print("Buyer Transaction Rate: \((transactionRate * 100).formatted())")
print("Transactions per Seller: \(sellerUtilization.formatted())")
...
print("Subscribers: \(month12Subscribers.formatted())")
...
print("Month \(month): \(subscribers.formatted()) subs (\(retention.percent()) retained)")
}
...
if let burnMultiple = model.calculateBurnMultiple(monthlyBurn: 50_000) {
	print("Burn Multiple: \(burnMultiple.formatted())x")
    if burnMultiple <= 1.5 {
