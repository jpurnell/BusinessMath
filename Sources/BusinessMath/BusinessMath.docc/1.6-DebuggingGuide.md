...
Task {
	...
	if bottlenecks.isEmpty {
		...
		for op in bottlenecks {
			print("\(op.operation):")
			print("  Average Time: \(op.averageTime.formatted())s")
			print("  Executions: \(op.executionCount)")
			print("  Total Time: \(op.totalTime.formatted())s")
		}
	}
...
Task {
	...
	print("Average: \(stats.averageTime.formatted())s")
	print("Std Dev: \(stats.stdDevTime.formatted())s")
	print("Min: \(stats.minTime.formatted())s")
	print("Max: \(stats.maxTime.formatted())s")
	print("Median: \(stats.medianTime.formatted())s")
	print("95th percentile: \(stats.percentile95.formatted())s")
	print("99th percentile: \(stats.percentile99.formatted())s")
