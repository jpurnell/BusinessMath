...
for (volume, profit) in profitTable {
	...
	print("\(volume.number().padding(toLength: 12, withPad: " ", startingAt: 0))\(revenue.currency().padding(toLength: 16, withPad: " ", startingAt: 0))\(totalCosts.currency().padding(toLength: 16, withPad: " ", startingAt: 0))\(profit.currency()) \(status)")
}
...
headerString += "\(volume.number())".paddingLeft(toLength: 14)
}
print(headerString)
