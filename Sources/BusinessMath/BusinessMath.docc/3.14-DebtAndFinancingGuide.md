...
for period in schedule.periods.prefix(3) {
	print("Payment: \(schedule.payment[period]!.currency())")  // Always ~$1,933.28
}
```
...
for period in schedule.periods.prefix(3) {
	print("Principal: \(schedule.principal[period]!.currency())")  // Always $5,000
	print("Total Payment: \(schedule.payment[period]!.currency())") // Declines each quarter
}
```
...
for period in schedule.periods.dropLast() {
	print("Principal Payment: \(schedule.principal[period]!.currency())")  // $0
	print("Interest Payment: \(schedule.interest[period]!.currency())")    // $13,750
}

// Last period includes full principal
let lastPeriod = schedule.periods.last!
print("Final Payment: \(schedule.payment[lastPeriod]!.currency())")  // $513,750
```
