...
Learn how to import financial statement data from JSON and CSV files into BusinessMath's role-based system.

## Overview

This guide demonstrates how to load financial statement data from external sources (JSON, CSV) into BusinessMath's role-based financial statement system. Whether you're integrating with accounting software, loading historical data, or importing analyst models, this guide shows you how to parse and validate external data.
...
> **Note**: All examples use the role-based financial statement architecture introduced in v2.0. See <doc:3.5-FinancialStatementsGuide> for details on the role-based system.
...
See <doc:3.16-FinancialStatementsReference> for complete role enum listings.
...
- Learn about <doc:3.5-FinancialStatementsGuide> for building financial statements
- Explore <doc:3.16-FinancialStatementsReference> for complete API details
- See <doc:3.4-BuildingFinancialReports> for integrated financial modeling
- Read <doc:4.2-ScenarioAnalysisGuide> for modeling different outcomes
