...
let shortTermROUAsset = shortTermLease.rightOfUseAsset()  // Returns 0
let shortTermSchedule = shortTermLease.liabilitySchedule()  // Returns zeros
```
...
let liabilityWithResidual = leaseWithResidual.presentValue()
```
...
let improvementROUAsset = monthlyLease.rightOfUseAsset()
let improvements = 50_000.0
let totalAsset = improvementROUAsset + improvements
