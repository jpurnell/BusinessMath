...
-----|------------|------------|----------------|---------------
 ...
 ... |    ...     |    ...     |      ...       |     ...
   30| $20,898.41 |    $685.41 |     $21,583.82 |          $0.00
```
...
// Scenario 1: Original (30-year, 6%) — values computed in Step 2
print("30-year @ 6.00%      | \(monthlyPayment.currency().paddingLeft(toLength: 9)) | \(totalPaid.currency(2).paddingLeft(toLength: 10)) | \(totalInterest.currency(2).paddingLeft(toLength: 14))")
...
print("30-year @ 7.00%      | \((paymentHighRate).currency().paddingLeft(toLength: 9)) | \(totalHighRate.currency(2).paddingLeft(toLength: 10)) | \(interestHighRate.currency(2).paddingLeft(toLength: 14))")
...
print("  • But increases payment by \((payment15yr - monthlyPayment).currency(2))/month")
