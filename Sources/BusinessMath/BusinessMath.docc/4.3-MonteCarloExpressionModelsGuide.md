...
// No `seed:` here — correlated sampling is not seedable yet, and passing one
// throws `SimulationError.seedingUnsupported` rather than quietly ignoring it.
// So this half of the comparison varies run to run; the independent half below
// does not.
