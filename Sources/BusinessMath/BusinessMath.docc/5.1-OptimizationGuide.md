...
print("Solution: \(bfgsResult.solution.toArray())")  // ~[1, 1]
...
print("Production quantities: \(productionPlan.productionQuantities.map({$0.key + ": " + $0.value.number(0)}))")
...
for (name, value) in driverResult.optimizedDrivers {
