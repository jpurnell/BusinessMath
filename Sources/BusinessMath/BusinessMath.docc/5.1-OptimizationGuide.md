...
let expectedReturns = VectorN([0.08, 0.12, 0.15])  // 8%, 12%, 15%
...
print("Production quantities: \(plan.productionQuantities.map({$0.key + ": " + $0.value.number(0)}))")
print("Profit: \(plan.profit.currency(0))")
```
