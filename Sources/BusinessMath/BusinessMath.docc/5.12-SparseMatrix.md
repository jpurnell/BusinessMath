...
let cgSolution = try cgSolver.solve(A: A, b: b, method: .conjugateGradient)
```
...
let bicgSolution = try bicgSolver.solve(A: A, b: b, method: .biconjugateGradient)
```
...
let previousSolution = [Double](repeating: 0.0, count: b.count)
