...
print("Optimal weights: \(result.solution.toArray().map { String(format: "%.3f", $0) }.joined(separator: ", "))")
print("Portfolio variance: \(String(format: "%.6f", result.value))")
print("Expected return: \(String(format: "%.4f", zip(result.solution.toArray(), returns).map(*).reduce(0, +)))")
```
...
print("  Learning Rate: \(result.solution[0].number(6))")
print("  Batch Size: \(Int(result.solution[1]))")
print("  Dropout Rate: \(result.solution[2].number(3))")
print("Validation Loss: \(result.value.number(4))")
```
...
print("Solution: [\(result.solution[0].number(4)), \(result.solution[1].number(4))]")
print("Function value: \(result.value.number(6))")
print("Generations: \(result.iterations)")
```
