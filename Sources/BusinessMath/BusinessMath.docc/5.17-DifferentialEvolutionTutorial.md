...
print("Rastrigin minimum: \(rastriginResult.value)")  // Should be near 0
```
...
print("CPU (100 pop): \(cpuTime.number(3))s, result: \(cpuResult.value.number(6))")
print("GPU (1000 pop): \(gpuTime.number(3))s, result: \(gpuResult.value.number(6))")
if cpuTime > 0 {
	print("Speedup: \((cpuTime / gpuTime).number(1))x")
}
```
