...
for (i, w) in weights.enumerated() {
    print("  Asset \(i+1): \((w/sum).percent(1))")
}
print("Sharpe ratio: \((-result.value).number(3))")
```
...
print("  Learning rate: \(result.solution[0].number(4))")
print("  Dropout rate: \(result.solution[1].number(2))")
print("  Batch size: \(Int(round(result.solution[2])))")
print("  Validation error: \(result.value.number(4))")
```
...
print("  Width: \(result.solution[0].number(1)) mm")
print("  Height: \(result.solution[1].number(1)) mm")
print("  Weight: \(result.value.number(2)) kg")
```
