...
let gpuResult = try! gpuOptimizer.minimize(gpuSphere, from: VectorN(Array(repeating: 2.0, count: 10)))

print("GPU-accelerated island model result: \(gpuResult.value)")
print("Total evaluations: \(gpuResult.iterations)")
```
...
print("Result: \(gpuStatusResult.value)")
```
...
print("  Best value: \(highDimResult.bestFitness)")
print("  Total evaluations: \(highDimResult.generations)")
print("  Best island: \(highDimResult.bestIslandIndex)")
```
