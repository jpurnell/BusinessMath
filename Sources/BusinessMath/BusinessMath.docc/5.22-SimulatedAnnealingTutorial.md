...
// Will always produce the same result with same seed
let result1 = try optimizer.minimize(objective, from: initialGuess)
let result2 = try optimizer.minimize(objective, from: initialGuess)
// result1.solution == result2.solution (deterministic)
```
