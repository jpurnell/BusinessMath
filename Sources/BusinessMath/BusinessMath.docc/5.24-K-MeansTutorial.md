...
let seededKMeans = KMeans<Vector2D<Double>>(seed: 42)
...
for _ in 0..<30 {
    playgroundData.append(Vector2D(x: Double.random(in: 0...2), y: Double.random(in: 0...2)))
    playgroundData.append(Vector2D(x: Double.random(in: 8...10), y: Double.random(in: 8...10)))
    playgroundData.append(Vector2D(x: Double.random(in: 4...6), y: Double.random(in: 4...6)))
}

// 2. Find optimal k using elbow method
let playgroundKMeans = KMeans<Vector2D<Double>>(seed: 42)
