...
print("Total Value: \(result.totalValue.currency(0))")
...
print("  Total Revenue: \(plan.revenue.currency(0))")
print("  Total Costs: \(plan.costs.currency(0))")
print("  Total Profit: \(plan.profit.currency(0))")
print("  Margin: \((plan.profit / plan.revenue).percent())")
...
print("Revenue: \(result.achievedMetrics["revenue"]!.currency(0))")
```
...
print("  Price: $\(result.optimizedDrivers["price"]!.number(2))")
print("  Headcount: \(Int(result.optimizedDrivers["headcount"]!))")
print("  Churn Rate: \(result.optimizedDrivers["churn_rate"]!.percent())")
print("\nResults:")
print("  ARR: \(result.achievedMetrics["arr"]!.currency())")
print("  Profit Margin: \(result.achievedMetrics["profit_margin"]!.percent())")
print("  Total Change Cost: \(cwResult.achievedMetrics["total_costs"]!.currency())")
```
