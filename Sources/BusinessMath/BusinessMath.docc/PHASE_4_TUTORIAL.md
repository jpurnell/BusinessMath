# Phase 4: Constrained Optimization - Complete Tutorial
...
Phase 4 adds **constrained optimization** to BusinessMath. While Phase 3 could optimize unconstrained functions, Phase 4 handles real-world problems with constraints:
...
Phase 4 completes the optimization framework with **proper constraint handling**:
...
4. Proceed to Phase 5 for business applications
