...
/// ```
public struct PCHIPInterpolator<T: Real & BinaryFloatingPoint & Sendable & Codable>: Interpolator {
    ...
    /// - Returns: Monotone-cubic interpolated y-value.
    ...
    /// - Returns: The PCHIP value at `t`, guaranteed overshoot-free.
