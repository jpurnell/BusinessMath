...
///
///	 - Parameters:
///		- u1Seed: A uniformly distributed random number in the range (0, 1). Defaults to a value generated by `distributionUniform()`.
///		- u2Seed: A uniformly distributed random number in the range (0, 1). Defaults to a value generated by `distributionUniform()`.
///
