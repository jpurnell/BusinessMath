...
struct DSCR_EdgeCaseTests {
	...
	func dscrWithFourQuarters() throws {
		...
		// Q2-Q4 should exist
		#expect(dscr[periods[1]]?.isFinite == true, "Q2 DSCR should exist")
		#expect(dscr[periods[2]]?.isFinite == true, "Q3 DSCR should exist")
		#expect(dscr[periods[3]]?.isFinite == true, "Q4 DSCR should exist")
	...
	func dscrWithCPLTDReclassification() throws {
		...
		if let q2Dscr = dscr[periods[1]] {
			...
			Issue.record("Q2 DSCR should exist")
		}
		...
		if let q3Dscr = dscr[periods[2]] {
			...
			Issue.record("Q3 DSCR should exist")
		}
		...
		if let q4Dscr = dscr[periods[3]] {
			...
			Issue.record("Q4 DSCR should exist")
		}
	}
}
