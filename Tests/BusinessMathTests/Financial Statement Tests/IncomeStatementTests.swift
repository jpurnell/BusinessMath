...
struct IncomeStatementTests {
	...
	func grossMargin() throws {
		...
		#expect(abs(try #require(grossMargin[q1]) - 0.6) < 1e-6)
	}
	...
	func operatingMargin() throws {
		...
		#expect(abs(try #require(operatingMargin[q1]) - 0.4) < 1e-6)
	}
	...
	func netMargin() throws {
		...
		#expect(abs(try #require(netMargin[q1]) - 0.4) < 1e-6)
	}
	...
	func ebitdaMargin() throws {
		...
		#expect(abs(try #require(ebitdaMargin[q1]) - 0.4) < 1e-6)
	}
	...
	func materialization() throws {
		...
		#expect(abs(try #require(materialized.grossMargin[q1]) - 0.6) < 1e-6)
		#expect(abs(try #require(materialized.operatingMargin[q1]) - 0.4) < 1e-6)
		#expect(abs(try #require(materialized.netMargin[q1]) - 0.4) < 1e-6)
	}
