...
struct DenseMatrixTests {
    ...
    @Test("Large matrix creation", .timeLimit(testHangGuard))
    ...
    @Test("Large matrix transpose", .timeLimit(testHangGuard))
    ...
    @Test("Large matrix-vector multiplication", .timeLimit(testHangGuard))
