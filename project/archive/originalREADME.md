...
|----------|---------|-------------|
| [**Master Plan**](master_plan.md) | Complete implementation roadmap | Starting a session, understanding overall architecture |
| [**Coding Rules**](coding_rules.md) | Style guide and standards | Writing any code, reviewing PRs |
| [**Usage Examples**](usage_examples.md) | Practical code examples | Understanding how to use the API, writing tests |
| [**DocC Guidelines**](docc_guidelines.md) | Documentation standards | Writing documentation, building docs |
| [**Implementation Checklist**](implementation_checklist.md) | Detailed task tracking | Daily implementation work, tracking progress |
...
1. **Review the Master Plan** ([master_plan.md](project/master_plan.md))
   - Understand the overall architecture
   - See the initial user request and context

2. **Check Coding Rules** ([coding_rules.md](development-guidelines/rules/coding_rules.md))
   - Refresh on Swift Testing syntax
   - Review DocC documentation patterns
   - Note the generic `<T: Real>` pattern

3. **Reference Usage Examples** ([usage_examples.md](development-guidelines/rules/usage_examples.md))
   - See how the API should work
   - Understand real-world use cases
   - Use for test inspiration

4. **Open the Checklist** ([implementation_checklist.md](development-guidelines/rules/implementation_checklist.md))
