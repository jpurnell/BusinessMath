...
- All 8 design proposals deleted from `BusinessMath/project/plans/proposals/`
...
1. `project/master_plan.md` — full roadmap
2. `project/plans/proposals/SIMULATION_INFRASTRUCTURE_AND_MARKET_INTEGRITY.md` — Layer 0 spec
